...
class ConsolidatedTransactionController extends Controller
{
    ...
    //     $res1 = ConsolidatedTransaction::select('consolidated_transactions.*', 'item_masterfiles.product_name AS product_name', 'item_masterfiles.keywords AS keywords', 'item_masterfiles.product_family AS product_family', 'item_masterfiles.description AS description', 'item_masterfiles.status AS sstatus', 'item_masterfiles.image AS image')
    //         ->join('item_masterfiles', 'consolidated_transactions.itemcode', '=', 'item_masterfiles.itemcode')
    ...
    //                                         $check = ConsolidatedTransaction::where('transaction_type', '=', $t_type)
    ...
    //                                                 ->where('uom', '=', $uom)
    //                                                 ->update(['nav_invoice_no' => $inv_no, 'del_qty' => $qty, 'amt' => $price, 'discount' => $discount, 'discounted_amount' => $discounted_line_amt, 'itm_stat' => 'Served', 'tot_amt' => $total_amt, 'flag' => 1]);
    ...
    //                                                 ->where('itm_code', '=', $itemcode)
    //                                                 ->where('uom', '=', $uom)
    //                                                 ->update(['nav_invoice_no' => $inv_no, 'del_qty' => $qty, 'amt' => $price, 'itm_stat' => 'Served', 'tot_amt' => $total_amt, 'flag' => 0]);
    ...
    //                                     ->where('itm_code', '=', $itemcode)
    //                                     ->where('uom', '=', $uom)
    //                                     ->update(['nav_invoice_no' => $inv_no, 'del_qty' => $qty, 'amt' => $price, 'tot_amt' => $total_amt, 'itm_stat' => 'Served', 'discount' => $calc, 'discounted_amount' => $total_disct, 'flag' => 1]);
    ...
    //         $get_tran = DB::table('tb_tran_head')
    //             ->whereDate('date_req', $date_request)
    //             ->get();
    ...
    //                     ->where('tran_no', '=', $data_tran->tran_no)
    //                     ->whereRaw('req_qty != del_qty AND del_qty != 0')
    //                     ->get();
                                        ...
                                        if ($check4 === true) {
                                            ...
                                            if ($check === false) {
                                                ...
                                                DB::table('tb_tran_head')
                                                    ...
                                                    ->whereDate('date_req', $date_request)
                                                    // ->update(['tran_stat' => 'Approved', 'date_app' => $date_request, 'date_transit' => $date_request]);
                                                    ->update(['tran_stat' => 'Approved', 'date_app' => $datetime_request, 'date_transit' => $date_request]);
