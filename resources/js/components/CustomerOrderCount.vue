    ...
    <div class="panel">
      <div class="panel-heading">
        <h3 class="panel-title" style="font-weight: bold; font-size: 20px;">
          <i class="fa fa-file-text-o"></i> Customer Order Count
        </h3>
      </div>
...
export default {
  ...
  methods: {
    printBtn() {
      document.location.href = `/topReports/printTotalOrderCount?date=${btoa(
        this.date
    ...
    getResults(page = 1) {
      ...
      url = `/topReports/totalOrderCount?date=${btoa(this.date)}&date2=${btoa(
        this.date2
      )}&page=`
