                        ...
                        <tbody>
                          ...
                          <tr
                            ...
                            :style="(MgaTransaction.tot_amt != 
                              parseFloat(MgaTransaction.lineTotal.toFixed(2))) ? 'color:red;' : ''"
                          >
                            <!-- kaloy 09-22-21 -->
                            ...
                            <td v-if="MgaTransaction.isExported === 1" 
                              :title="MgaTransaction.export_date">
                              <span>Yes</span>
                            </td>
                            <td v-if="MgaTransaction.isExported === 0" 
                              :title="MgaTransaction.export_date">
                              <span>No</span>
                            </td>
                            <td
