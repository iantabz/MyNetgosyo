                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <div
                            class="thumbnail"
                            v-if="
                              form1.image !== '../distribution.alturush.com/'
                            "
                          >
                            <img
            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div
                    class="thumbnailx"
                    v-if="form.image !== '../distribution.alturush.com/'"
                  >
                    <img
                    ...
                    />
                    <div class="caption">
                      <h5 v-if="form.image !== '../distribution.alturush.com/'"
                        class="text-center">
                        {{ form.prdct_name }}
                      </h5>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <div
                            class="thumbnail"
                            v-if="
                              form2.image !== '../distribution.alturush.com/'
                            "
                          >
                            <img
...
export default {
  ...
  methods: {
    ...
    details1(MgaConsolidated) {
      ...
      // this.form2.image = $root.adminAccess + '' + MgaConsolidated.image
      // this.form2.noimage = $root.adminAccess + 'item-images/no_image_item.jpg'
    ...
    details(MgaItems) {
      ...
      // this.form.image = $root.adminAccess + '' + MgaItems.image
      // this.form.noimage = $root.adminAccess + 'item-images/no_image_item.jpg'
      ...
      axios
        ...
        .then(response => {
          ...
          this.items_log_data.forEach(item => {
            ...
            this.form1.image = '../distribution.alturush.com/' + item.image
            this.form1.noimage = '../distribution.alturush.com/item-images/no_image_item.jpg'
