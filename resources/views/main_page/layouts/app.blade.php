...
<body onload="zoom()">
                ...
                <div id="navbar-container" class="boxed">
                    ...
                    <div class="navbar-content">
                        ...
                        <ul class="nav navbar-top-links">
                            ...
                            <!--kaloy 2021-10-07-->
                            <li>
                                <router-link to="/transactions" class="aside-toggle">
                                    <i class="fa fa-shopping-cart"></i>
                                    <ongoing-transactions-pending-count
                                        class="badge-sm"
                                        style="margin-bottom:16px;"></ongoing-transactions-pending-count>
                                </router-link>
                            </li>
                            ...
                            <div class="nano has-scrollbar">
                                ...
                                document.getElementById('logout-form1').submit();" class="list-group-item">
                                    ...
                                    <ul id="mainnav-menu" class="list-group">
                                        ...
                                        <li>
                                            <router-link tag="li" class="nav-item" to="/dashboard3"><a href="#">
                                                    <i class="fa fa-home"></i>
                                                    <span class="menu-title">Dashboard</span>
                                                </a></router-link>
                                        </li>
                                        ...
                                        <li>
                                            <router-link tag="li" class="nav-item" to="/transactions"><a href="#">
                                                    ...
                                                    <span class="menu-title">Orders Transaction
                                                        <!-- kaloy 2021-10-06 -->
                                                        <span class="pull-right">
                                                            <ongoing-transactions-pending-count></ongoing-transactions-pending-count>
                                                        </span>
                                                    </span>
                                                </a></router-link>
                                        </li>
                                        @if(auth()->user()->type === 'Admin' || auth()->user()->type === 'MIS' || auth()->user()->type === 'Customer Service')
                                        <li>
                                            <router-link tag="li" class="nav-item" to="/tele_ordering"><a href="#">
                                                    <i class="fa fa-truck"></i>
                                                    <span class="menu-title">Tele-Ordering</span>
                                                </a></router-link>
                                        </li>
                                        @endif
                                        @if(auth()->user()->type === 'Admin' || auth()->user()->type === 'MIS')
                                        <li>
                                        ...
                                        <li>
                                         ...
                                         <li>
                                            ...
                                            <router-link tag="li" class="nav-item" to="/customer_feedbacks"><a href="#">
                                                    <i class="fa fa-users"></i>
                                                    <span class="menu-title">Customer Feedbacks</span>
                                                </a></router-link>
                                        ...
                                        <li>
                                            <router-link tag="li" class="nav-item" to="/order-cut-off-time"><a href="#">
                                                    <i class="fa fa-server"></i>
                                                    <span class="menu-title">Order Cut-off Time</span>
                                                </a></router-link>
                                        </li>
                                        ...
                                        <li>
                                            <router-link tag="li" class="nav-item" to="/salesman">
                                                <a href="#">
                                                    ...
                                                    <span class="menu-title">Salesman & Jefe de Viaje</span>
                                                </a>
                                            </router-link>
                                        </li>
                                        ...
                                        @if(auth()->user()->type === 'Customer Service')
                                        <li class="list-divider"></li>
                                        ...
                                        <li>
                                            <router-link tag="li" class="nav-item" to="/salesreport"><a href="#">
                                                    <i class="fa fa-print"></i>
                                        ...
                                        <li>
                                            <router-link tag="li" class="nav-item" to="/order_history"><a href="#"><i
                                                        class="fa fa-print"></i><span class="menu-title">Order
                                                        History</span></a></router-link>
                                        </li>
                                        @endif
                                        ...
                                        @if(auth()->user()->type === 'Internal Audit')
                                        <li class="list-divider"></li>
                                        <li class="list-header">Reports</li>
    ...
    <!-- kaloy 2021-10-05 -->
    <!--HumanizeDuration.js-->
    <script src="{{ asset('assets/js/humanize-duration.min.js') }}"></script>
