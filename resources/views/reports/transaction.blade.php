            ...
            <tr>
                <td colspan="4">
                    <table class="body1" cellspacing="0">
                        <thead>
                            <tr>
                                <th colspan="7">RETURNED ITEMS</th>
                            </tr>
                            <tr>
                                <th>Item Code</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">P {{ number_format($item['total_ret_amt'],2) }}</td>
                                {{-- @if($item['discount'] == 0)
                                    <td> - </td>
                                @else
                                <td>{{ $item['discount'] }}%</td>
                ...
                <td colspan="4">
                    ...
                    <table class="body2">
                        <tr>
                            ...
                            <td width="15%" style="text-align: right; text-align: right;">P {{ number_format($sum_total_ret_amt,2) }}</td>
                        ...
                        <tr>
                            ...
                            <td width="10%" style="text-align: right;">{{ $sum_ret_qty }}</td>
                            <td width="15%" style="font-weight: bold;"></td>
