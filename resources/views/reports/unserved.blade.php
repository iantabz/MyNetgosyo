            ...
            <tr>
                <td colspan="4">
                    <table class="body1" cellspacing="0">
                        <thead>
                            <tr>
                                <th colspan="7">UNSERVED ITEMS</th>
                            </tr>
                            <tr>
                                <th>Item Code</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">P {{ $item['amt'] }} </td>
                                <td>{{ $item['uom'] }}</td>
                                ...
                                <td style="text-align: right">P {{ number_format($item['total_uns_amt'],2) }}</td>
                                {{-- @if($item['discount'] == 0)
                                    <td> - </td>
                                @else
                                <td>{{ $item['discount'] }}%</td>
                            ...
                            <?php 
                                ...
                                $sum_total_uns_amt += $item['total_uns_amt'];
                ...
                <td colspan="4">
                    ...
                    <table class="body2">
                        <tr>
                            ...
                            <td width="10%" style="text-align: right;">{{ $sum_qty }}</td>
                            <td width="15%" style="font-weight: bold;"></td>
                            <td width="15%" style="font-weight: bold; text-align: right;">Gross Total Amt >>></td>
                            <td width="15%" style="text-align: right; text-align: right;">P {{ number_format($sum_total_uns_amt,2) }}</td>
                            <td width="5%" style="font-weight: bold;"></td>
                            {{-- <td width="20%" style="font-weight: bold; text-align: right"></td> --}}
                        </tr>

                        <tr>
                            <td width="15%" style="font-weight: bold; text-align: right;">Total Unserved Qty >>></td>
                            <td width="10%" style="text-align: right;">{{ $sum_uns_qty }}</td>
                            <td width="15%" style="font-weight: bold;"></td>
